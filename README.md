About airflow-balancer-feedstock
================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/airflow-balancer-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/airflow-balancer-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add airflow-balancer
# for installing globally
pixi global install airflow-balancer
```
...
It is possible to list all of the versions of `airflow-balancer` available on your platform:
...
```
pixi search airflow-balancer --channel conda-forge
```
